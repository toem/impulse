...
int main() {
	...
	// buffers
	flxBuffer buffer1 = flxCreateLinearBuffer(memoryBuffer, bufferSize, flxWriteToFile, out); // writes to files

	// trace
	flxTrace trace = flxCreateTrace(0, MAX_ITEM_ID, MAX_ENTRY_SIZE, memoryTrace, traceSize, buffer1);
