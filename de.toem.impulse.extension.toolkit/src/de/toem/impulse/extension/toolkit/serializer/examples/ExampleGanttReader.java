...
public class ExampleGanttReader extends AbstractSingleDomainRecordReader {

    public ExampleGanttReader() {
        super();
    }

    public ExampleGanttReader(String id, InputStream in) {
        super(id, in);
    }
    ...
    protected void parse(IProgress progress, InputStream in) throws ParseException {
        ...
        Signal event2 = addSignal(signals, "Event2", "Enum events with string", 
                ProcessType.Discrete, SignalType.Event, SignalDescriptor.EventGantt);
        ...
        Signal struct1 = addSignal(signals, "Struct1", "A struct signal", ProcessType.Discrete, 
                SignalType.Struct, SignalDescriptor.StructGantt);
        ...
        eventWriter.attachRelation(event6.getPath(), "Trigger//", 0);
        eventWriter.write(50000, false,new String[]{"Started","Off"});
        eventWriter.attachRelation(event5.getPath(), "Trigger//", 5000);
        ...
        eventWriter.attachRelation(event4.getPath(), "Reset//", -12000);
