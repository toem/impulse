package de.toem.impulse.extension.toolkit.serializer.wizard;
...
public class NewReaderTemplate extends OptionTemplateSection {
    ...
    protected URL getInstallURL() {
        return ImpulseToolkitExtension.getDefault().getInstallURL();
    }
    ...
    private void createOptions() {
        ...
        addOption("readerTemplate", "Template:",
                new String[][] { { "text", "Text Line Reader" }, { "binary", "Binary Data Reader" }, { "empty", "Empty Reader" } }, "text", 0);
        addOption("createStreamReader", "Create stream reader (Handles continues input stream when using ports)", false, 0);
        addOption("readerConfiguration", "Reader Configuration:", new String[][] { { "none", "No Reader Configuration" },
                { "default", "Default Reader Configuration" }/* , { "custom", "Custom Reader Configuration" } */ }, "none", 0);
    ...
    public IPluginReference[] getDependencies(String schemaVersion) {
        ...
        result.add(new PluginReference("de.toem.eclipse.toolkits.ui", null, 0));
