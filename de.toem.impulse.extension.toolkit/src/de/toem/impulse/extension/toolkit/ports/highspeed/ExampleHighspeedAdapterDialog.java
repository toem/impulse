...
public class ExampleHighspeedAdapterDialog extends AbstractElementDialog {
    ...
    public ExampleHighspeedAdapterDialog(ITlkEditor parent, IController controller) {
        super(parent, controller);
    }

    public ExampleHighspeedAdapterDialog(ITlkEditor parent, IElement parentElement, ICell newCell) {
        super(parent, parentElement, newCell);
    }

    public ExampleHighspeedAdapterDialog(ITlkEditor parent, IElement element) {
        super(parent, element);
    }

    public ExampleHighspeedAdapterDialog(ITlkEditor parent, List<IElement> elements) {
        super(parent, elements);
    }

    public ExampleHighspeedAdapterDialog(ITlkEditor parent) {
        super(parent);
    }
    ...
    public static IControlProvider getControls() {
        IControlProvider provider = new AbstractControlProvider() {
            ...
            public boolean fillThis() {
                try {
                    tlk().addText(container(), new TextController(editor(), ExampleHighspeedAdapter.class.getField("signalCount")), cols(), DialogToolkit.LABEL | TLK.BORDER,
                            "No of Signals:");   
                    tlk().addText(container(), new TextController(editor(), ExampleHighspeedAdapter.class.getField("signalRate")), cols(), DialogToolkit.LABEL | TLK.BORDER,
                            "Signal rate (us):");  
                    tlk().addText(container(), new TextController(editor(), ExampleHighspeedAdapter.class.getField("burstRate")), cols(), DialogToolkit.LABEL | TLK.BORDER,
                            "Burst rate (ms):"); 
                    tlk().addText(container(), new TextController(editor(), ExampleHighspeedAdapter.class.getField("samples")), cols(), DialogToolkit.LABEL | TLK.BORDER,
                            "No of samples:"); 
