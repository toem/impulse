...
import de.toem.impulse.extension.jdt.IBreakpointListener;
import de.toem.impulse.extension.jdt.JavaBreakpointNotifier;
			...
			try {
				...
				if (signal != null) {
					...
					if (writer instanceof IIntegerSamplesWriter && o instanceof Number)
						...
						((ILogicSamplesWriter) writer).write(current, false, (byte) (o == Boolean.TRUE ? ISample.STATE_1_BITS : ISample.STATE_0_BITS));
