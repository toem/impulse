package de.toem.eclipse.derived.swt;
...
public class TextActionHandler {
	...
	private class DeleteActionHandler extends Action {
		...
		public void runWithEvent(Event event) {
			if (activeTextControl != null && !activeTextControl.isDisposed()) {
				...
				activeTextControl.setSelection(selection.x,
							selection.x);
				updateActionsEnableState();
				return;
			}
		...
		public void updateEnabledState() {
			if (activeTextControl != null && !activeTextControl.isDisposed()) {
				int sc = activeTextControl.getSelectionCount();
				setEnabled(sc > 0 && activeTextControl.getEditable());
	...
	public void setGlobalActionHandler(IActionBars actionBar) {
	 ...
	 * 
	 * @param action
	 *            the <code>IAction</code> to run for the Select All action,
	 *            or <code>null</code> if not interested.
	 */
	...
	/**
	 * Set the default <code>IAction</code> handler for the Delete action.
	 * This <code>IAction</code> is run only if no active inline text control.
	 * 
	 * @param action
