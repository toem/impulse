 ...
 */
public class EyeTrace extends Trace {

    public EyeTrace(String name, Axis xAxis, Axis yAxis, IDataProvider dataProvider) {
...
//        graphics.pushState();
//        if (use_advanced_graphics)
//            graphics.setAntialias(antiAliasing ? TLK.ON : TLK.OFF);
//        graphics.setForegroundColor(traceColor);
//        graphics.setLineWidth(lineWidth);
//        ISample predp = null;
